const quizData = [
    ...
    //     options: ["Not a Number", "Negative Number", "New and Null", "No assigned Number"],
    //     correct: 0
    // },
    // {
    ...
    // },
    // {
    //     question: "Which method converts an object to JSON string?",
    ...
    },
    {
        ...
        options: ["repeat()", "concat()", "copy()", "loop()"],
        correct: 0
    }
];
